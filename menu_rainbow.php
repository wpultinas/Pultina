...
<!-- HEADER  -->
	<div class="desktop-menu">
      <div class=" container-fluid header row">
        ...
        <div class="col-4 logo-rainbow"><a href="index.html"><img src="/Pultina_images/pultinalogoredmix.svg" alt="Pultina logo"></a></div>
		...
		<div class="col-4 cart-button">
		  <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post" >
			...
			<input type="image" src="/Pultina_images/shopping_cart.png" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!" style=" width: 20%; height: auto; padding-top: 3%;">
