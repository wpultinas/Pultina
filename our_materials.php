...
<html lang="en">
<head>
  <title>Our Materials — Pultina</title>
  <meta charset="utf-8">
...
<!-- PAGE HERO -->
<section class="page-hero materials-hero">
  <div class="hero-overlay"></div>
  <div class="hero-content">
    <p class="section-eyebrow light">What we use</p>
    <h1 class="hero-title">Reclaimed. Repurposed. Recycled.</h1>
  </div>
</section>
...
<section class="home-section section-light">
  <div class="container-fluid">
    <div class="row section-row">
      <div class="col-md-12 section-text-col brand-text-col">
        <h2 class="section-heading">Our materials are carefully selected for quality and durability from local and national sources.</h2>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container-fluid">
    <div class="row footer-row">
      <div class="col-md-4 footer-brand">
        <img src="Pultina_images/pultinalogonew.svg" alt="Pultina logo" class="footer-logo">
        <p class="footer-tagline">ZERO WASTE GOODS</p>
      </div>
      <div class="col-md-4 footer-links">
        <a href="policy_contact.php">Contact</a>
        <a href="#">Instagram</a>
      </div>
      <div class="col-md-4 footer-links">
        <a href="policy_contact.php#policyanchor">Policies &amp; Payments</a>
      </div>
    </div>
  </div>
</footer>
