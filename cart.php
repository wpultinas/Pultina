    ...
    <form action="cart.php" method="post">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td class="img">
                        <a href="productnewjava1.php?id=<?=$product['id']?>">
                            <img src="Pultina_images/<?=$product['image_1']?>" width="50" height="50" alt="<?=$product['name']?>">
                        </a>
                    </td>
                    <td>
                        <a href="productnewjava1.php?id=<?=$product['id']?>"><?=$product['name']?></a>
                        <br>
